...
function enterShop () {
    ...
    shopUI.setScale(1, ScaleAnchor.Middle)
    shopEasingVariable = 200
    for (let index = 0; index < 20; index++) {
        shopUI.setScale(1 / (1 + e ** (2 * (5 - 5 * (shopEasingVariable / 10)))), ScaleAnchor.Middle)
        shopEasingVariable += -1
    }
}
